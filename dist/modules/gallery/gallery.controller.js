...
__decorate([
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("./entities/gallery.entity").Gallery }),
...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./entities/gallery.entity").Gallery] }),
    __metadata("design:type", Function),
